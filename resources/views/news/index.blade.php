...
@section('content')
    ...
    <div class="flex flex-row justify-between">
        <h1 class="text-4xl font-bold pb-10">Nieuwsberichten</h1>
        <a href="/dashboard/news/create" class="btn btn-primary">Aanmaken</a>
    </div>
        <div style="overflow: scroll;">
            <table class="table">
                ...
                @foreach($news as $newsItem)
                    ...
                    <th>
                        <a href="/dashboard/news/{{ $newsItem->id }}/edit" class="btn btn-ghost btn-xs">Aanpassen</a>
                    </th>
                </tr>
                @endforeach
                </tbody>
